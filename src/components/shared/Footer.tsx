  ...
  return (
    <footer className='p-5 items-center text-center bottom-0 w-full flex flex-col'>
      <div className={isMobile ? 'm-1 flex flex-col justify-center space-y-4 align-items-center' : 'm-1 flex justify-center space-x-4 align-items-center'}>
        <Link href="/" rel="noopener noreferrer" className='mx-2 hover:underline font-light footer-link'>CGU</Link>
        <Link href="/" rel="noopener noreferrer" className='mx-2 hover:underline font-light footer-link'>Politique de confidentialité</Link>
        <Link href="/" rel="noopener noreferrer" className='mx-2 hover:underline font-light footer-link'>Mentions légales</Link>
        <Link href="/" rel="noopener noreferrer" className='mx-2 hover:underline font-light footer-link'>Contact</Link>
